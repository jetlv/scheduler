...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["My home postal code is 470117", "My home property type is HDB 3 Room", "What is the estimated price of my home?"],    /* You can change the home section typing text from
